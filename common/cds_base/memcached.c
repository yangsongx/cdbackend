...
char *convert_err_to_str(int errcode)
{
    ...
    switch(errcode)
    {
        ...
        GOTO_STRING(CDS_ERR_LIBC_FAILURE);
        GOTO_STRING(CDS_ERR_USER_ALREADY_EXISTED);
        GOTO_STRING(CDS_ERR_REQ_PROTOBUF_INCORRECT);
        GOTO_STRING(CDS_ERR_INCORRECT_CODE);
        GOTO_STRING(CDS_ERR_CODE_EXPIRED);
        GOTO_STRING(CDS_ERR_INACTIVATED);
        GOTO_STRING(CDS_ERR_REJECT_LOGIN);
