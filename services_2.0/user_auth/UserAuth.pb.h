...
// optional uint64 caredear_id = 3;
inline bool AuthResponse::has_caredear_id() const {
  return (_has_bits_[0] & 0x00000004u) != 0;
}
inline void AuthResponse::set_has_caredear_id() {
  _has_bits_[0] |= 0x00000004u;
}
inline void AuthResponse::clear_has_caredear_id() {
  _has_bits_[0] &= ~0x00000004u;
}
inline void AuthResponse::clear_caredear_id() {
  caredear_id_ = GOOGLE_ULONGLONG(0);
  clear_has_caredear_id();
}
inline ::google::protobuf::uint64 AuthResponse::caredear_id() const {
  // @@protoc_insertion_point(field_get:com.caredear.AuthResponse.caredear_id)
  return caredear_id_;
}
inline void AuthResponse::set_caredear_id(::google::protobuf::uint64 value) {
  set_has_caredear_id();
  caredear_id_ = value;
  // @@protoc_insertion_point(field_set:com.caredear.AuthResponse.caredear_id)
}
